...
export const ProfileDashboard = ({ onBack }: { onBack: () => void }) => {
  return (
       ...
       <div className="px-4 pb-4">
          <div className="flex justify-between items-start">
            <div className="relative -mt-20 mb-3">
              <img src={CURRENT_USER.avatar} className="w-36 h-36 rounded-full border-4 border-white object-cover bg-white" />
            </div>
